...
const Home = () => {
  return (
    <div className="text-on-surface" dir="rtl">
      <NewNavbar />
      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-8 relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 text-right">
              ...
              <p className="text-xl text-on-surface-variant font-manrope font-light max-w-lg leading-relaxed">
                بنختارلك أحسن الكتب المستعملة بكل حب. حاجات مستدامة، سعرها حنين، وليها ريحة الزمن الجميل. انضم لأكتر من 10 آلاف عاشق للقراءة.
              </p>
          ...
          <div className="bg-surface-container-lowest p-6 rounded-2xl shadow-[0_20px_40px_rgba(27,28,26,0.05)]">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-grow relative">
                ...
                <input
                  className="w-full pr-12 pl-6 py-4 bg-surface-container-high rounded-xl border-none focus:ring-2 focus:ring-primary-container text-on-surface placeholder-on-surface-variant/60 font-manrope"
                  placeholder="دور بالعنوان، المؤلف، أو الرقم الدولي للكتاب..."
                  type="text"
                />
              </div>
          ...
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-on-surface-variant font-manrope">
                اختياراتنا المختارة عبر كل الآفاق الأدبية.
              </p>
            </div>
            <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 h-[600px]">
            ...
            <div className="md:col-span-2 relative rounded-2xl overflow-hidden group">
              ...
              <div className="absolute bottom-8 right-8 text-white text-right">
                <h3 className="text-3xl font-notoSerif mb-2">روايات</h3>
            ...
            <div className="relative rounded-2xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent"></div>
              <div className="absolute bottom-8 right-8 text-white text-right">
                <h3 className="text-2xl font-notoSerif mb-1">كتب علمية</h3>
            ...
            <div className="relative rounded-2xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent"></div>
              <div className="absolute bottom-8 right-8 text-white text-right">
                <h3 className="text-2xl font-notoSerif mb-1">كلاسيكيات</h3>
                <p className="text-sm font-manrope opacity-80">
                  حكايات مابتخلصش.
                </p>
              </div>
            ...
            <div className="md:col-span-2 relative rounded-2xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent"></div>
              <div className="absolute bottom-8 right-8 text-white text-right">
                <h3 className="text-3xl font-notoSerif mb-2">تطوير الذات</h3>
                <p className="font-manrope opacity-80">
                  قوي رحلتك.
                </p>
              </div>
            ...
            <div className="md:col-span-2 relative rounded-2xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent"></div>
              <div className="absolute bottom-8 right-8 text-white text-right">
                <h3 className="text-3xl font-notoSerif mb-2">كنوز نادرة</h3>
                <p className="font-manrope opacity-80">لهواة الاقتناء.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 overflow-hidden">
          <div className="max-w-7xl mx-auto px-8 mb-10 text-right">
          ...
          <div className="flex overflow-x-auto gap-8 px-8 md:px-[calc((100vw-80rem)/2+2rem)] hide-scrollbar snap-x">
            ...
            <div className="min-w-[280px] snap-start group text-right">
              <div className="aspect-[2/3] bg-surface-container rounded-xl overflow-hidden mb-4 relative shadow-sm hover:shadow-xl transition-shadow duration-300">
                ...
                />
                <div className="absolute top-4 left-4 bg-primary text-white text-[10px] font-manrope font-bold px-3 py-1 rounded-full uppercase tracking-tighter">
                  جديد
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 justify-end">
                ...
                <span className="font-manrope font-bold text-lg">120 ج.م</span>
              </div>
            </div>
            {/* Book Card 2 */}
            <div className="min-w-[280px] snap-start group text-right">
          ...
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="flex flex-col items-center space-y-4 group">
              ...
              <p className="text-sm font-manrope text-on-surface-variant leading-relaxed">
                كل كتاب بيتراجع يدوي عشان نضمن حالته وأصالته.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 group">
              <div className="w-16 h-16 bg-surface-container-lowest rounded-full flex items-center justify-center text-primary-container shadow-sm group-hover:scale-110 transition-transform">
              ...
              <p className="text-sm font-manrope text-on-surface-variant leading-relaxed">
                تغليف يحمي كتبك عشان توصلك في أحسن حالة.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 group">
              <div className="w-16 h-16 bg-surface-container-lowest rounded-full flex items-center justify-center text-primary-container shadow-sm group-hover:scale-110 transition-transform">
              ...
              <p className="text-sm font-manrope text-on-surface-variant leading-relaxed">
                أحسن قيمة في المنطقة. لقيتها أرخص؟ هنوفق السعر.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="md:w-1/3 text-right">
              ...
              <p className="text-lg font-manrope text-on-surface-variant mb-8">
                اكتشف أحدث الكتب اللي انضمت لينا. من أكتر الكتب مبيعاً لنوادر منسية، مجموعتنا بتكبر كل يوم.
              </p>
              <Link
                to="/home"
            ...
            <div className="md:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className="bg-surface-container-lowest p-4 rounded-xl shadow-sm hover:translate-y-[-4px] transition-transform text-right">
                <img
              ...
              <div className="bg-surface-container-lowest p-4 rounded-xl shadow-sm hover:translate-y-[-4px] transition-transform hidden md:block text-right">
                <img
                  className="w-full aspect-[3/4] object-cover rounded-lg mb-3"
